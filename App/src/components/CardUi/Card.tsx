...
//     if (props.icon === "Youtube" && thumbnail) {
//       return (
...
//               src={thumbnail}
//               alt={props.title}
//               className="w-[90%] h-36 object-cover rounded-lg shadow-md hover:scale-105 transition-transform"
//             />
//           </a>
//         </div>
//       );
...
//         <div className="flex justify-center items-center py-4">
//           <a href={props.link} target="_blank" rel="noopener noreferrer">
//             <div className="w-[90%] h-36 flex items-center justify-center bg-blue-100 rounded-lg shadow-md">
//               <TwitterIcon />
//             </div>
//           </a>
//         </div>
...
//         <div className="flex justify-center items-center py-4">
//           <a href={props.link} target="_blank" rel="noopener noreferrer">
//             <div className="w-[90%] h-36 flex items-center justify-center bg-gray-100 rounded-lg shadow-md">
//               <NotionIcon />
//             </div>
//           </a>
//         </div>
...
//   return (
//     <div className="border w-[19vw] min-h-[52vh] rounded-xl shadow-lg bg-white flex flex-col justify-between hover:shadow-xl transition duration-200">
//       {/* Header */}
//       <div className="flex justify-between items-center px-4 py-3 border-b">
//         <div className="flex items-center gap-2">
//           <DocumentIcon />
//           <span className="font-semibold text-lg truncate">{props.title}</span>
//         </div>
//         <div className="cursor-pointer hover:text-red-500" onClick={deleteHandle}>
//           <DeleteIcon />
//         </div>
//       </div>
